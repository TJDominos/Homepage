...
const newBtn1 = `className=\`w-[120px] h-[28px] p-0 flex items-center justify-center rounded-2xl text-[14px] leading-[20px] font-medium transition-colors \${
                  gameCategory === "Rand Game"`;
...
const newBtn2 = `className=\`w-[120px] h-[28px] p-0 flex items-center justify-center rounded-2xl text-[14px] leading-[20px] font-medium transition-colors \${
                  gameCategory === "Randball"`;

content = content.replace(oldBtn2, newBtn2);

fs.writeFileSync('src/frontend/PayoutPage.tsx', content, 'utf-8');
console.log("Updated button sizes for real");
