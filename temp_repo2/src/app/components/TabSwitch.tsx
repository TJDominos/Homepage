...
export function TabSwitch({ activePage, setActivePage }: TabSwitchProps) {
  return (
    <nav className="flex-shrink-0 bg-white/95 backdrop-blur-md border-t border-gray-200 shadow-2xl">
      <div className="max-w-xl mx-auto flex justify-around items-center py-1.5">
        {/* Money */}
        <button 
        ...
        >
          <svg className="w-9 h-9" viewBox="0 0 27 27" fill="none">
          ...
          <span style={{ fontSize: '16px', fontWeight: 400 }}>Money</span>
        </button>
        ...
        >
          ...
          <span style={{ fontSize: '16px', fontWeight: 400 }}>Play</span>
        </button>
        ...
        >
          ...
          <span style={{ fontSize: '16px', fontWeight: 400 }}>Inbox</span>
        </button>
        ...
        >
          ...
          <span style={{ fontSize: '16px', fontWeight: 400 }}>History</span>
        </button>
      </div>
    </nav>
  );
