...
import { Gift, ArrowUpCircle, ArrowRightLeft, ChevronDown, Loader2, Sparkles } from "lucide-react";
...
export function BonusTab({ isDesktop }: BonusTabProps) {
  ...
  return (
          <div className="flex flex-col mt-4">
            <h2 className="text-[16px] font-[600] text-slate-800 mb-2 px-1">
              Bonus
            </h2>
            <div className="text-[14px] text-slate-500 leading-relaxed font-normal mb-5 px-1">
              Bonuses can be used for gameplay or converted to WLT. Claim a
              bonus code, or top up by converting your Gcoin and WLT.
            </div>
                  ...
                  {claimStatus === "idle" || claimStatus === "processing" ? (
                    ...
                    >
                      ...
                      <div className="w-full flex-1 flex flex-col justify-end gap-3 mt-auto">
                        ...
                        <button
                          ...
                          disabled={claimStatus === "processing"}
                          className={`bg-[#333] text-white flex items-center justify-center font-[600] transition-all outline-none ${
                            "w-[80px] h-[28px] text-[13px] rounded-full mx-auto"
                          } ${claimStatus === "processing" ? "bg-black/50 cursor-not-allowed" : "hover:bg-black active:scale-95"}`}
                        >
                          {claimStatus === "processing" ? (
                    ...
                    >
                      ...
                      <button
                        ...
                        className={`bg-[#333] text-white flex items-center justify-center font-[600] hover:bg-black active:scale-95 transition-all outline-none mt-auto ${
                          "w-[80px] h-[28px] text-[13px] rounded-full mx-auto"
                        }`}
                      >
                        OK
                      ...
                      <div className="w-full flex-1 flex flex-col justify-end gap-3 mt-auto">
                        <div className="flex flex-col w-full">
                          <div className="flex gap-2">
                            <div className="relative shrink-0 w-[40%] min-w-[90px]">
                              <button
                          ...
                          <div className="h-[20px] flex items-center justify-center mt-1 w-full">
                            {parseFloat(topUpAmount) > 0 ? (
                              <span className="text-[12px] font-medium text-green-600 leading-[1]">
                                ≈ {formatNumber(calculateBonusFromTopUp())}{" "}
                                Bonus
                              </span>
                            ) : !topUpAmount ? (
                        ...
                        <button
                          ...
                          className={`bg-[#333] text-white flex items-center justify-center font-[600] transition-all outline-none ${
                            "w-[80px] h-[28px] text-[13px] rounded-full mx-auto"
                          } ${topUpStatus === "processing" ? "bg-black/50 cursor-not-allowed" : "hover:bg-black active:scale-[0.98]"}`}
                        >
                          {topUpStatus === "processing" ? (
                            <Loader2 className="w-4 h-4 animate-spin text-white/70" />
                          ) : (
                    ...
                    >
                      ...
                      <div className="w-full flex-1 flex flex-col justify-end gap-3 mt-auto">
                        ...
                        <button
                          ...
                          className={`bg-[#333] text-white flex items-center justify-center font-[600] transition-all outline-none ${
                            "w-[80px] h-[28px] text-[13px] rounded-full mx-auto"
                          } ${swapStatus === "processing" ? "bg-black/50 cursor-not-allowed" : "hover:bg-black active:scale-95"}`}
                        >
                          {swapStatus === "processing" ? (
                            <Loader2 className="w-4 h-4 animate-spin text-white/70" />
                          ) : (
