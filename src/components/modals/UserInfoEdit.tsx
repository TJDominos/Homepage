...
import { ChevronLeft, User, Power, ChevronDown, X, Wallet, Key } from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";
import "../../frontend/MoneyPage.css";
              ...
              <div className="px-4 pb-4">
                <div className="bg-[#e4e5f0] border border-white/40 rounded-2xl p-3 shadow-sm  flex flex-col gap-2.5">
                  ...
                  <div>
                    ...
                    !userAccount.startsWith("ii-") ? (
                      ...
                      <div className="flex items-center gap-2 w-full bg-[#e8e9ef] text-slate-400 text-[13px] rounded-xl px-4 py-2 outline-none transition-all">
                        ...
                        <button
                          type="button"
                          className="text-[#7E57C2] font-medium text-[14px] hover:underline"
                          ...
                          <div key={pk.id} className="flex items-center justify-between w-full bg-[#e8e9ef] text-[13px] rounded-xl px-4 py-2 outline-none transition-all">
                            ...
                            {index === passkeys.length - 1 && passkeys.length < 3 && (
                              <button
                                ...
                                className="text-[#7E57C2] font-medium text-[14px] hover:underline shrink-0 ml-2"
                              >
                                Add
                              </button>
                            )}
                  ...
                  <div className="space-y-3 pt-1">
                    <a
                      href="#"
                      className="text-[12px] mb-1 text-[#7E57C2] underline underline-offset-2 hover:opacity-80 block tracking-tight text-center transition-opacity"
                    >
