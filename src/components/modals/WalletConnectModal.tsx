...
type Step = "SELECT_WALLET" | "CONNECTING" | "PENDING" | "SUCCESS" | "ERROR";
          ...
          >
            <div className="flex items-center justify-between px-4 pt-4 pb-4 border-b border-black/5">
              <h3 className="font-semibold text-black tracking-wide text-[16px]">
                {step === "SELECT_WALLET" ? "Sign In" : "Sign In Status"}
              </h3>
              <button
                onClick={() => onClose()}
              ...
              {step === "SELECT_WALLET" && (
                ...
                >
                  <p className="text-[14px] text-[#7a8699] mb-3 px-3">
                    Sign in to continue. An account will be created if no record is found.
                  </p>
              ...
              {step === "ERROR" && (
                ...
                >
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <button
                      onClick={() => setStep("SELECT_WALLET")}
                      className="mt-2 px-6 py-2 bg-black text-white rounded-full text-sm font-semibold hover:bg-slate-800 transition-colors"
                    >
                      Try Again
                    </button>
                  </div>
