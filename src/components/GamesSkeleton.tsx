        ...
        <div className="desktop-game-grid">
          {Array.from({ length: 4 }).map((_, index) => (
            <div key={index} className="desktop-game-card opacity-85">
              {/* Logo Skeleton */}
              <div className="desktop-game-logo skeleton-banner" style={{ width: "70px", height: "70px", borderRadius: "10px" }} />
              {/* Content Skeleton */}
  ...
  return (
    <div className="game-section">
      ...
      <div className="game-list">
        {Array.from({ length: 4 }).map((_, index) => (
          <div key={index} className="game-item opacity-85 select-none" style={{ background: "transparent", boxShadow: "none" }}>
            {/* Logo Skeleton */}
            <div className="game-logo skeleton-banner" style={{ width: "52px", height: "52px", borderRadius: "10px", marginRight: "12px" }} />
            {/* Content Skeleton */}
