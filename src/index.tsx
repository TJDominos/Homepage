...
function App() {
  ...
  const activeTab = (validTabs.includes(path) ? path : "play") as "money" | "play" | "inbox" | "history" | "rank";
        ...
        <div className="home-header">
          <div className="home-header-content py-[12px] md:py-[10px] px-2">
            ...
            <div className="flex items-center gap-2.5 md:gap-4 shrink-0">
              ...
              >
                <svg className="w-6 h-6 md:w-[20px] md:h-[20px]" viewBox="0 0 27 27" fill="none" stroke="currentColor">
                ...
                {[
                  ...
                  >
                    <div className="mr-1.5 w-4 h-4 flex items-center justify-center">
                       ...
                       {tab.id === 'rank' && <Trophy size={14} strokeWidth={activeTab === 'rank' ? 2 : 1.5} />}
