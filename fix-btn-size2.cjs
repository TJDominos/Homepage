...
const newBtn1 = `className=\`w-[120px] h-[28px] py-0 rounded-2xl text-[14px] leading-[20px] font-medium transition-colors flex items-center justify-center \${
                  gameCategory === "Rand Game"`;
...
const newBtn2 = `className=\`w-[120px] h-[28px] py-0 rounded-2xl text-[14px] leading-[20px] font-medium transition-colors flex items-center justify-center \${
                  gameCategory === "Randball"`;
